...
var jwtMiddleware = function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, now, userRepository, user, newToken, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(decoded.exp - now < 60 * 60 * 24 * 3.5)) return [3 /*break*/, 4];
            ...
            case 3:
                user = _a.sent();
                newToken = authController_1.generateToken(user.id, user.email);
